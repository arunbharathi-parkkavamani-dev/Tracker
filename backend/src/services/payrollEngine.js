...
export function computeSalary(attendanceSummary, structure) {
  ...
  return { earnedBreakdown, deductionBreakdown, grossSalary, netSalary, lopDays, overtimePay };
}
...
export async function runPayrollForEmployee(employeeId, month, year, processedBy, runId) {
  ...
  return { payrollId: payroll._id, grossSalary: computed.grossSalary, netSalary: computed.netSalary };
}
