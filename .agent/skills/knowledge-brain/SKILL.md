...
Read `.agent/skills/frontend-ui-tokens/SKILL.md`, [design-tokens.md](design-tokens.md), `frontend/src/styles/tokens.css`, and `frontend/src/constants/uiTokens.js` (Profile palette). Full marketing spec: `backend/DESIGN.md`.
